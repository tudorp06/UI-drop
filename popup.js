...
/**
 * Build a rich Markdown "skill" file that can be:
 *   - dropped into a Claude Project as knowledge
 *   - used as a Cursor `.cursorrules` reference
 *   - imported into any AI tool that reads markdown context
 *
 * Way richer than the competitor's output — uses every token UIDrop scrapes,
 * organises them semantically, and ends with explicit DO/DON'T implementation
 * rules so the AI doesn't just copy the design.
 */
